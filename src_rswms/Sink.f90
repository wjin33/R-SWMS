...
!> ### Couvreur RWU model input; Couvreur.in ###
    SUBROUTINE CouIn	!Couvreur feb 2011
      USE GridData
      ...
      IMPLICIT NONE
      INTEGER(sp):: el,i_dJvL,i_UptakeDomain,i
      REAL(sp):: element
...
SUBROUTINE SetSnk(t,BCr,BCtp)
  ...
  USE RootData, ONLY: lCou,lSUF,lDou,lFed,lJarvis,OmegaC,Krs,Kcomp,lno_RWU,ldJvL,tlim_dJvL,Rho,lPast,tPast,sinkredDPast,nrec,seglen,segsur,Hseq,lSign_new
  ...
  REAL(sp) :: alpha,active,active_cube,ConcE,t,HElm2(nElm),Lr_fact(1:nrec),Gap,AQPc,J_loc
