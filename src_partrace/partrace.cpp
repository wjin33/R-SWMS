...
{ 
  ...
  while(RunTime.NotReady()) {
    ...
    std::cout<<"doAllBoundaryInjections"<<RunTime.Seconds()<<"secs"<<std::endl;
    ...
    std::cout<<"injectallparticles"<<RunTime.Seconds()<<"secs"<<std::endl;
    ...
    std::cout<<"CalculateAllMicrobialDecay "<<RunTime.Seconds()<<"secs"<<std::endl;
    particles.CalculateAllUptake();
    parallel->sync();
    if(Debugging()) debug<<"CalculateAllUptake "<<RunTime.Seconds()<<"secs"<<endl;
    std::cout<<"CalculateAllUptake "<<RunTime.Seconds()<<"secs"<<std::endl;
    ...
    std::cout<<"MoveAllParticles "<<RunTime.Seconds()<<"secs"<<std::endl;
